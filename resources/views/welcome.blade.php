...
<div class="container">
    <div class="row">
        <div class="col">
            <h1 class="mt-6 text-center"><img
                    src="https://www.taysad.org.tr/Uploads/UyeLogo/050720211411232magna_logo1.png" alt="Magna"></h1>
            <hr>
        </div>
    </div>
    <form id="parametreForm" method="POST" action="{{route('excel_form')}}" class="container my-4">
        ...
        <div class="row mb-3">
            <div class="col-md-6 mt-2">
                ...
                <input type="text" class="form-control" id="enjeksiyonSuresi" name="enjeksiyonSuresi"
                       placeholder="Süre Girin">
            </div>
            <div class="col-md-6 mt-2">
                <label for="cycleTime" class="form-label">Soğutma Süresi</label>
                <input type="text" class="form-control" id="sogutmaSuresi" name="sogutmaSuresi"
                       placeholder="Süre Girin">
            </div>
            <div class="col-md-6 mt-3">
                <label for="cycleTime" class="form-label">Mal Alma Zamanı</label>
                <input type="text" class="form-control" id="malAlmaZamani" name="malAlmaZamani"
                       placeholder="Süre Girin">
            </div>
        </div>
        <div class="row mb-3">
            ...
            <div class="col-md-6 mt-2">
                ...
                <input type="text" class="form-control" id="gerceklesenBasinc" name="gerceklesenBasinc"
                       placeholder="Bar Girin">
            </div>
        </div>
        <hr>
        &nbsp;
        ...
        <div class="container mt-4" style="margin-left: -1%;">
            <h2 class="section-title">Sıralı Yolluklar</h2>
            <div id="input-container">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control decimal" name="kademe1_kapama[]"
                               placeholder="Kapama Süresi">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control decimal" name="kademe2_kapama[]"
                               placeholder="Kapama Süresi">
                    </div>
                </div>
            </div>
        ...
        <div class="container mt-3">
            ...
            <div class="mb-4" style="margin-left: -1%;">
                ...
                <input type="text" id="tutmaBaslangici" name="tutmaBaslangici" class="form-control"
                       placeholder="Tutma Başlangıcı">
            </div>
            <div id="tutma-container" style="margin-left: -1%;">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" step="0.01" class="form-control" name="tutma_basinc[]"
                               placeholder="Basınç değeri">
                    </div>
                </div>
            </div>
        ...
        <div class="mt-3">
            <div class="row">
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" name="yastikMiktari" id="yastikMiktari"
                           placeholder="Yastık Miktarı">
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-6">
                    <label>1- Geri Emiş Önce (mm):</label>
                    <input type="text" class="form-control" name="geriEmisOnce1" id="geriEmisOnce1"
                           placeholder="Geri Emiş Önce">
                </div>
                <div class="col-6">
                    <label>1- Geri Emiş Sonra (mm):</label>
                    <input type="text" class="form-control" name="geriEmisSonra1" id="geriEmisSonra1"
                           placeholder="Geri Emiş Sonra">
                </div>
            </div>
            <div class="row mt-2">
                <div class="col-6">
                    <label>Önce Hız:</label>
                    <input type="text" class="form-control" name="geriEmisOnce2" id="geriEmisOnce2"
                           placeholder="Geri Emiş Önce">
                </div>
                <div class="col-6">
                    <label>Sonra Hız:</label>
                    <input type="text" class="form-control" name="geriEmisSonra2" id="geriEmisSonra2"
                           placeholder="Geri Emiş Sonra">
                </div>
            </div>
        </div>
        ...
        <div class="container mt-4" style="margin-left: -1%;">
            <h2 class="section-title text-left">Silindir Isıları</h2>
            ...
            <h2 class="section-title text-left" style="margin-left: 0%;">Sıcak Yolluk Isıları (Hot Runner)</h2>
        ...
        <div class="container mt-4" style="margin-left: -1%;">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="kalipKapamaKuvveti" id="kalipKapamaKuvveti" class="form-control"
                       placeholder="Kapama Kuvveti (KN)">
            </div>
            <div class="container mt-4" style="margin-left: -1%;">
                <!-- Mold Opening -->
