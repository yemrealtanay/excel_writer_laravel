...
<div class="container">
    ...
    <form id="parametreForm" method="POST" action="{{route('excel_form')}}" class="container my-4">
        ...
        <div class="container mt-4">
            <h1 class="section-title">Sıralı Yolluklar</h1>
            ...
            <div id="input-container">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control" name="kademe1_acma[]" placeholder="Açma Süresi">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">1. Kademe Kapama</label>
                        <input type="number" class="form-control" name="kademe1_kapama[]" placeholder="Kapama Süresi">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">2. Kademe Açma</label>
                        <input type="number" class="form-control" name="kademe2_acma[]" placeholder="Açma Süresi">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">2. Kademe Kapama</label>
                        <input type="number" class="form-control" name="kademe2_kapama[]" placeholder="Kapama Süresi">
                    </div>
                </div>
            </div>
            <a class="btn btn-primary" id="add-group-btn">+ Yolluk Ekle</a>
        </div>

        <!-- Cooler Set Degree Section -->
        <div class="mb-4 mt-3">
            <h2 class="section-title">Soğutucu Set Derecesi</h2>
            <div id="cooler-container">
                <div class="row g-3 mb-3">
                    <!-- Fixed Inputs -->
                    <div class="col-md-3">
                        <label class="form-label">Sabit 1</label>
                        <input type="number" class="form-control" name="sabit_sogutucu" placeholder="Isı Değeri">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Hareketli 1</label>
                        <input type="number" class="form-control" name="hareketli_soğutucu" placeholder="Isı Değeri">
                    </div>
        ...
        <div class="container mt-4">
            <h1 class="section-title">Enjeksiyon Hızları ve Mesafeleri</h1>
            <div id="injection-container">
                <!-- İlk Satır -->
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        <label class="form-label">POS</label>
                        <input type="number" class="form-control" name="injection_pos[]" placeholder="Pozisyon">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">SPEED</label>
                        <input type="number" class="form-control" name="injection_speed[]" placeholder="Hız">
                    </div>
                </div>
            </div>
            <a class="btn btn-primary" id="add-injection-btn">+ Pozisyon Hız Ekle</a>
        </div>
        ...
        <div class="container mt-3">
            ...
            <!-- Tutma Section -->
            <div class="mb-4">
                <h2 class="section-title">Tutma Parametreleri</h2>

                <label for="tutmaBaslangici" class="form-label"><strong>Tutma Başlangıcı (MM)</strong></label>
                <input type="number" id="tutmaBaslangici" name="tutmaBaslangici" class="form-control" placeholder="Tutma Başlangıcı">
                </div>


                <div id="tutma-container">
                    <!-- First Tutma Group -->
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            <label class="form-label">Zaman 1 (sn)</label>
                            <input type="number" class="form-control" name="tutma_zaman[]" placeholder="Zaman değeri">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Basınç 1 (Bar)</label>
                            <input type="number" step="0.01" class="form-control" name="tutma_basinc[]" placeholder="Basınç değeri">
                        </div>
                    </div>
                </div>
                <button type="button" class="btn btn-primary" id="add-tutma-btn">
            ...
            <div class="mt-3">
                <div class="row">
                    <div class="col-6">
                        ...
                        <input type="number" class="form-control" name="yastikMiktari" id="yastikMiktari" placeholder="Yastık Miktarı">
                    </div>
                </div>
                <div class="row mt-2">
                    <div class="col-6">
                        <label>1- Geri Emiş Önce (mm):</label>
                        <input type="number" class="form-control" name="geriEmisOnce1" id="geriEmisOnce1" placeholder="Geri Emiş Önce">
                    </div>
                    <div class="col-6">
                        <label>1- Geri Emiş Sonra (mm):</label>
                        <input type="number" class="form-control" name="geriEmisSonra1" id="geriEmisSonra1" placeholder="Geri Emiş Sonra">
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    <div class="col-6">
                        ...
                        <input type="number" class="form-control" name="geriEmisOnce2" id="geriEmisOnce2" placeholder="Geri Emiş Önce">
                    </div>
                    <div class="col-6">
                        <label>Sonra Hız:</label>
                        <input type="number" class="form-control" name="geriEmisSonra2" id="geriEmisSonra2" placeholder="Geri Emiş Sonra">
                    </div>
                </div>
            </div>
        ...
        <!--Mal Alma-->
        <div class="container mt-4">
            <h1 class="section-title">Mal Alma</h1>
            ...
            <div id="distance-container">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" name="hiz[]" placeholder="Hız değeri">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Geri Basınç (B/Prbar)</label>
                        <input type="number" class="form-control" name="basinc[]" placeholder="Basınç değeri">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Yol -s (mm)</label>
                        <input type="number" class="form-control" name="yol[]" placeholder="Yol değeri">
                    </div>
                </div>
            </div>
            <a class="btn btn-primary" id="add-distance-btn">+ Mesafe Ekle</a>
        </div>

        <div class="container mt-4">
            <h1 class="section-title">Isılar</h1>
            <h2 class="mb-4 text-left">Silindir Isıları</h2>
            ...
            <div id="cylindir_tempreture-container">
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" name="silindir_isi_1" placeholder="Isı Değeri">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">2</label>
                        <input type="number" class="form-control" name="silindir_isi_2" placeholder="Isı Değeri">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">3</label>
                        <input type="number" class="form-control" name="silindir_isi_3" placeholder="Isı Değeri">
                    </div>

                    <div class="col-md-4">
                        <label class="form-label">4</label>
                        <input type="number" class="form-control" name="silindir_isi_4" placeholder="Isı Değeri">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">5</label>
                        <input type="number" class="form-control" name="silindir_isi_5" placeholder="Isı Değeri">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">6</label>
                        <input type="number" class="form-control" name="silindir_isi_6" placeholder="Isı Değeri">
                    </div>

                    <div class="col-md-4">
                        <label class="form-label">7</label>
                        <input type="number" class="form-control" name="silindir_isi_7" placeholder="Isı Değeri">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">8</label>
                        <input type="number" class="form-control" name="silindir_isi_8" placeholder="Isı Değeri">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">9</label>
                        <input type="number" class="form-control" name="silindir_isi_9" placeholder="Isı Değeri">
                    </div>

                    <div class="col-md-4">
                        <label class="form-label">10</label>
                        <input type="number" class="form-control" name="silindir_isi_10" placeholder="Isı Değeri">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">11</label>
                        <input type="number" class="form-control" name="silindir_isi_11" placeholder="Isı Değeri">
                    </div>

                </div>
            </div>

            <h2 class="mb-4 text-left">Sıcak Yolluk Isıları (Hot Runner)</h2>
            <div id="hotrunner-container">
                <!-- First Hot Runner Group -->
                <div class="row g-3 mb-3">
                    <div class="col-md-2">
                        <label class="form-label">H1</label>
                        <input type="number" class="form-control" name="hotrunner[]" placeholder="Isı Değeri">
                    </div>
                    <div class="col-md-2">
            ...
            <a class="btn btn-primary" id="add-hotrunner-btn">+ Sıcak Yolluk Ekle</a>

        </div>

        <!--KAPAMA / (CLOSING) - MOLD / (KALIP) UNIT-->
        <div class="container mt-4">
            <h1 class="section-title">Kapama / (Closing) - Mold / (Kalıp) Unit</h1>

            <div class="mb-3">
                <label for="tutmaBaslangici" class="form-label"><strong>Kalıp Kapama Kuvveti (KN)</strong></label>
                <input type="number" name="kalipKapamaKuvveti" id="kalipKapamaKuvveti" class="form-control" placeholder="Kapama Kuvveti (KN)">
            </div>

            <div class="container mt-4">
                <!-- Mold Opening -->
                <h2 class="mb-4 text-left">Kalıp Açma</h2>
                <div id="mold-opening-container">
                    <!-- First Input Group -->
                    <div class="row g-3 mb-3">
                        <div class="col-md-6">
                            <label class="form-label">Mesafe 1</label>
                            <input type="number" class="form-control" name="acma_mesafesi[]" placeholder="Mesafe Değeri">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Hız 1</label>
                            <input type="number" class="form-control" name="acma_hizi[]" placeholder="Hız Değeri">
                        </div>
                    </div>
                </div>
                <a class="btn btn-primary" id="add-opening-btn">+ Açma Mesafesi Ekle</a>
            </div>
...
<div class="container">
    <div class="row">
        <div class="col text-center">
            <hr>
            <small class="text-muted">Making by Erhan Akça</small>
        </div>
    </div>
</div>
...
<script>
    ...
    document.getElementById('add-hotrunner-btn').addEventListener('click', function() {
        ...
        const startNumber = (groupCount * 6) + 1;
        ...
        const remainingInputs = Math.min(6, 55 - startNumber + 1);
        ...
        for (let i = 0; i < remainingInputs; i++) {
            ...
            inputsHTML += `
            <div class="col-md-2">
                <label class="form-label">H${currentNumber}</label>
                <input type="number" class="form-control" name="hotrunner[]" placeholder="Isı Değeri">
            </div>
        `;
        }
